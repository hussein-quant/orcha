...
/// the decluttered gold direction (Hanken Grotesk on the web, SF Pro here —
/// see `Palette.applyMinimalTraits`). Orthogonal to `ThemeMode` — dark/light/
/// auto keeps working on all three.
