/* ============================================================================
   open-orcha#209 (cloud port) — task results render as "[object Object]" when structured.
...
assert(!/mdText\(t\.result\)/.test(SRC) && !/mdText\(isPlan[^)]*t\.result \|\| "—"/.test(SRC),
  "no render site passes t.result to mdText unwrapped");
