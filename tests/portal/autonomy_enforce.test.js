/* ============================================================================
   orcha-cloud #64, upstream GH #207 (mig 043) — the "Enforce for all agents" lock chip beside the 3-level
...
async function run() {
  console.log("autonomy_enforce.test.js — orcha-cloud #64 (enforce-for-all lock chip)\n");
  ...
  // --- Case 1: default render — chip present, unlit; 3 levels untouched ------
  {
    ...
    assert(!/\bon\b/.test(chip._class), "chip is unlit by default (mig-043 default: not enforced)");
