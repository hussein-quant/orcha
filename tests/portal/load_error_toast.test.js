/* ============================================================================
   ...
   Dependency-free (mirrors project_switcher.test.js): real data.js in a vm
   sandbox; setInterval is captured so the test drives the tick cadence.
...
function fakeFetch(url) {
  ...
  if (u.indexOf("/api/me") >= 0)
    return Promise.resolve({ ok: true, json: () => Promise.resolve({ identity: null }) });
